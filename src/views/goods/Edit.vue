    ...
    <div><!--v-loading.fullscreen.lock="loading"-->
        <el-form :model="form" :rules="rules" ref="form">
            ...
            <el-form-item label="商品名称">
                <el-input v-model.number="form.gname" placeholder="请输入5-30个字符" clearable=""></el-input>
            </el-form-item>
            <el-form-item label="商品描述">
                <el-input v-model.number="form.description" placeholder="请输入简单描述" clearable=""></el-input>
            </el-form-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            insertGoods(){
                api('post',HOSTNAME+'/api/goods',this.data)
            }
        },
        watch: {
            bannerArr() {
